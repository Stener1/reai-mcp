...
export type ServerConfig = {
   ...
   *
   * The whole premise of this server is that 320 API operations cannot all be
...
export const TOOLSETS = ["bookkeeping", "sales", "purchase", "bank", "organisation", "assets", "subscriptions", "warehouses", "agreements", "salary", "reference", "loans", "investments"] as const;
