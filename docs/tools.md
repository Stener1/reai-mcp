...
It sits outside the default surface rather than inside it — every count on this page and in the README is the default 172, and `REAI_ENABLE_UI=1` registers a 173rd tool.
