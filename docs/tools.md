...
**The phone number is normalised, not merely validated.** `90123456`, `004790123456` and `+4790123456` are all stored as `+4790123456`, so the schema's "international E.164 format" describes what comes back rather than what has to go in. The tools report the renormalisation, on the update as well as the create — more important there, since a previous value was overwritten. An invalid Norwegian number is refused in Norwegian: `"Skriv inn et gyldig telefonnummer. Norske nummer kan skrives uten +47."`
