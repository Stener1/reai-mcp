 ...
 *
 * Two live audits already existed, and between them they named **2 of the 130 quirks**:
 * `tenant-header-ignored-single-tenant` and `customer-name-title-cased`. That 2, and the 130, are exact.
 *
 ...
 * checkable statement is the one that matters: of **130** quirks, **17** now have a live case — the 16 here plus
 ...
 * rather than the first one in the README. Count distinct ids and check the total against 130.
 *
